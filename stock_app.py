...
if df is None or len(df) < 5:
    ...
    fig.update_layout(height=500, template="plotly_dark", xaxis_rangeslider_visible=False, margin=dict(t=10, b=10))
    st.plotly_chart(fig, use_container_width=True)

    # --- 7. BOTTOM PREDICTION PANEL ---
    st.markdown("---")
    ...
    if prediction_mode == "Next Day (Tomorrow)":
        ...
        # Scalp Target based on recent 15 bars
    ...
    # Safeguard prediction within 5% range
